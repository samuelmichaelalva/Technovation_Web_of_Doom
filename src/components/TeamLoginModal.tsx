...
export const TeamLoginModal: React.FC<TeamLoginModalProps> = ({ onSessionStarted, onAdminClick }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Automatically generate a unique Team ID for the session
    const autoGeneratedTeamId = generateRandomTeamId();

    setIsLoading(true);
    setErrorMsg('');
    soundEngine.playClick();

    const res = await initializeTeamSession(autoGeneratedTeamId, teamName.trim());
    setIsLoading(false);
